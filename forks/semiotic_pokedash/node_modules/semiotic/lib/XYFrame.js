    ...
    value: function calculateXYFrame(currentProps) {
      ...
      if (!currentProps.dataVersion || currentProps.dataVersion && currentProps.dataVersion !== this.state.dataVersion) {
        if (!xExtent || !yExtent || !fullDataset || !projectedLines && !projectedPoints && !projectedAreas) {
          ;
          var _calculateDataExtent = (0, _dataFunctions.calculateDataExtent)(_extends({}, currentProps, { xExtent: xExtent, yExtent: yExtent }));
...
XYFrame.propTypes = {
  ...
  xExtent: _propTypes2.default.oneOfType([_propTypes2.default.array, _propTypes2.default.object]),
  yExtent: _propTypes2.default.oneOfType([_propTypes2.default.array, _propTypes2.default.object]),
  ...
  customAreaMark: _propTypes2.default.func,
