...
var OrdinalFrame = (_temp = _class = function (_React$Component) {
  ...
  _createClass(OrdinalFrame, [{
    ...
    value: function calculateOrdinalFrame(currentProps) {
      ...
      var eventListenersGenerator = (0, _frameFunctions.generateOrdinalFrameEventListeners)(customHoverBehavior, customClickBehavior);
      ...
      var calculatedOExtent = [].concat(_toConsumableArray(new Set(allData.map(function (d, i) {
      ...
      var nestedPieces = {};
      (0, _d3Collection.nest)().key(function (d, i) {
      ...
      var summaryCanvasRender = (0, _dataFunctions.stringToFn)(canvasPieces, undefined, true);
    ...
    value: function defaultORSVGRule(_ref2) {
      ...
      var pieceIDAccessor = (0, _dataFunctions.stringToFn)(this.props.pieceIDAccessor, function (p) {
      ...
      var screenProject = function screenProject(p) {
        ...
        var idPiece = pieceIDAccessor(d) && oColumn.pieceData.find(function (r) {
          return pieceIDAccessor(r.data) === pieceIDAccessor(d);
        });

        if (oColumn && projection === "radial") {
          return (0, _pieceDrawing.pointOnArcAtAngle)([adjustedSize[0] / 2, adjustedSize[1] / 2], oColumn.pct_middle, idPiece ? (idPiece.bottom + idPiece.scaledValue / 2) / 2 : rScale(rAccessor(p)) / 2);
        }
        if (projection === "horizontal") {
...
OrdinalFrame.propTypes = {
  ...
  oExtent: _propTypes2.default.oneOfType([_propTypes2.default.array, _propTypes2.default.object]),
  rExtent: _propTypes2.default.oneOfType([_propTypes2.default.array, _propTypes2.default.object]),
  ...
  tooltipContent: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.func]),
  ...
  pixelColumnWidth: _propTypes2.default.number,
