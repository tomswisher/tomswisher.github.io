...
function createPoints(_ref2) {
  ...
  data.forEach(function (d, i) {
    ...
    var markProps = customMark ? _extends(baseMarkProps, renderedCustomMark.props) : _extends({}, baseMarkProps, { key: "piece-" + i, markType: "circle", r: 2 });
...
function createAreas(_ref4) {
  ...
  data.forEach(function (d, i) {
    ...
    if (_react2.default.isValidElement(drawD)) {
